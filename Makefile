...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mon Mar 18 16:50:04 2013
# Project:  main.pro
# Template: app
...
SOURCES       = advisory.cpp \
		...
		sector.cpp \
		hurEyePoints.cpp \
		slider.cpp mocs/moc_window.cpp \
		mocs/moc_mapWin.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) objs/main1.0.0/ && $(COPY_FILE) --parents advisory.h bin.h geoFunct.h gridPoint.h gridStruct.h hurVis.h ImageFile.h Matrix.h P6Image.h path.h pathSegment.h posPoint.h predictedPath.h screenshot.h simulation.h Utility.h Vector.h velocityFunct.h window.h mapWin.h chip.h sector.h hurEyePoints.h slider.h objs/main1.0.0/ && $(COPY_FILE) --parents advisory.cpp bin.cpp geoFunct.cpp gridStruct.cpp hurVis.cpp main.cpp Matrix.cpp P6Image.cpp path.cpp pathSegment.cpp posPoint.cpp predictedPath.cpp simulation.cpp Utility.cpp Vector.cpp velocityFunct.cpp window.cpp mapWin.cpp chip.cpp sector.cpp hurEyePoints.cpp slider.cpp objs/main1.0.0/ && (cd `dirname objs/main1.0.0` && $(TAR) main1.0.0.tar main1.0.0 && $(COMPRESS) main1.0.0.tar) && $(MOVE) `dirname objs/main1.0.0`/main1.0.0.tar.gz . && $(DEL_FILE) -r objs/main1.0.0
